...
struct PlayerView: View {
    ...
    init(roomID: String) {
        _vm = StateObject(wrappedValue: PlayerViewModel(apiService: SpotifyAPIService(authService: SpotifyAuthService()), backendService: PartyBackendService(baseURL: Config.backendURL)))
        self.roomID = roomID
    }
