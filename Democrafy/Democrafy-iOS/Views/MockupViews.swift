...
struct MockupViews_Previews: PreviewProvider {
    ...
    static var previews: some View {
        Group {
            ...
            NavigationView { SearchView(vm: SearchViewModel(apiService: SpotifyAPIService(authService: SpotifyAuthService()), backendService: PartyBackendService(baseURL: Config.backendURL)), room: sampleRooms[0]) }
